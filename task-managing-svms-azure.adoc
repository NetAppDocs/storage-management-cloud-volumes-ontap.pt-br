...
Para obter informações sobre como executar chamadas da API do Cloud Volumes ONTAP, consulte  https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["Sua primeira chamada de API"^].
...
.Antes de começar
O agente do Console requer permissões específicas para criar VMs de armazenamento para o Cloud Volumes ONTAP. As permissões necessárias estão incluídas em  https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["as políticas fornecidas pela NetApp"^].
...
.Antes de começar
O agente do Console requer permissões específicas para gerenciar VMs de armazenamento para o Cloud Volumes ONTAP. As permissões necessárias estão incluídas em  https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["as políticas fornecidas pela NetApp"^].
