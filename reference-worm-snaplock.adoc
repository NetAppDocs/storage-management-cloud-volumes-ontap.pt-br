...
.Links relacionados
* Para obter mais informações sobre o WORM, consulte:link:concept-worm.html["Saiba mais sobre o armazenamento WORM no Cloud Volumes ONTAP"] .
* Para obter informações sobre o carregamento de volumes SnapLock , consultelink:concept-licensing-charging.html["Licenciamento e cobrança no Cloud Volumes ONTAP"] .
