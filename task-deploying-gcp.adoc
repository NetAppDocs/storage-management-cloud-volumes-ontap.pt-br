...
+
Saiba mais sobre  https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html#flash-cache-support["Cache Flash"^] e link:concept-write-speed.html["velocidade de escrita"].
