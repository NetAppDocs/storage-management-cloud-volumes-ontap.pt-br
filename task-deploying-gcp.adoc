...
| Editar Projeto  a| 
Selecione o projeto onde você deseja que Cloud Volumes ONTAP resida.
...
. *Modelos de implantação de alta disponibilidade*: escolha várias zonas (recomendado) ou uma única zona para a configuração de alta disponibilidade. Em seguida, selecione uma região e uma zona.
+
