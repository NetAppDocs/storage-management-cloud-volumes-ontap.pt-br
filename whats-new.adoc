...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-convert-node-capacity.html#conversion-in-a-private-mode-deployment["Conversão em uma implantação de modo privado"^]
...
* A assinatura está registrada para o recurso da Microsoft `Microsoft.Compute/VMOrchestratorZonalMultiFD`. https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-saz-feature.html["Aprenda como habilitar o VMOrchestratorZonalMultiFD para zonas de disponibilidade únicas"^].
