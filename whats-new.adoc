...
Para contratos anuais/ofertas privadas do marketplace do Cloud Volumes ONTAP, o cálculo de excedentes para licenças Essentials agora está alinhado com os pacotes Bring-Your-Own License (BYOL). Anteriormente, os excedentes eram cobrados nas taxas horárias do marketplace para o pacote Essentials exato. Agora, se o seu contrato anual do marketplace incluir vários pacotes Essentials, o NetApp Console cobrará os excedentes de um pacote Essentials com base na capacidade disponível de um pacote Essentials de preço mais alto em sua assinatura. Isso simplifica os cálculos de excedentes para pacotes Essentials e garante uma transição tranquila do modelo de licenciamento BYOL para um modelo baseado em assinatura.
...
Para mais informações, consulte  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-client-protocols.html#nvme-tcp["Protocolos de cliente suportados para Cloud Volumes ONTAP: NVMe-TCP"^].
...
A partir de 25 de junho de 2025, a NetApp restringiu o modelo de licenciamento Bring-Your-Own License (BYOL) para o Cloud Volumes ONTAP. A restrição se aplica a todos os clientes e a todas as implantações do Cloud Volumes ONTAP na AWS, Azure e Google Cloud. As únicas exceções são os clientes do setor público dos EUA e as implantações na região da China.
...
* Se você possui um pacote válido e não expirado de Bring-Your-Own License (BYOL) por nó
...
A partir da versão 9.9.1, o Cloud Volumes ONTAP agora oferece suporte ao tipo de instância m5dn.24xlarge com os seguintes métodos de cobrança: PAYGO Premium, Bring-Your-Own License (BYOL) e Freemium.
