...
summary: Você pode implantar o Cloud Volumes ONTAP nos ambientes AWS Secret Cloud e Top Secret Cloud. As regiões AWS Secret Cloud e Top Secret Cloud são regiões fechadas específicas para a Comunidade de Inteligência dos EUA. As instruções nesta página se aplicam somente a usuários das regiões AWS Secret Cloud e Top Secret Cloud. 
---
...
+
Para saber mais sobre como funciona o modo privado, consulte link:https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#private-mode["o modo de implantação privada no Console"^].
