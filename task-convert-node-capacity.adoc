...
* A ferramenta de conversão de licenças suporta todos os tipos de implantação, como nó único, alta disponibilidade (HA) em uma única zona de disponibilidade (AZ), HA em várias AZ, Bring-Your-Own License (BYOL) e pagamento conforme o uso.
...
== Conversão em uma implantação em modo privado
...
Como as assinaturas do marketplace não são compatíveis com o modo privado, você precisa adquirir um pacote Essentials Bring-Your-Own License ou BYOL da NetApp. Isso permite que você mantenha os benefícios do licenciamento baseado em capacidade dentro do modelo BYOL, sem a necessidade de assinaturas do marketplace.
