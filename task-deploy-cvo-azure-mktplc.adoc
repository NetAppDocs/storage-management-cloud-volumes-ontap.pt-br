...
.Antes de começar
* Se você planeja descobrir e gerenciar o sistema implantado no NetApp Console, certifique-se de que a conta do NetApp Console esteja associada a uma assinatura válida do Azure Marketplace. A descoberta do sistema no NetApp Console requer uma assinatura válida.
