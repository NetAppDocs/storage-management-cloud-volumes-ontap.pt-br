...
O NetApp Console fornece gerenciamento de volumes FlexCache com o link:https://docs.netapp.com/us-en/console-volume-caching/index.html["NetApp armazenamento em cache de volumes"^].
