...
* link:link:reference-configs-azure.html["Configurações com suporte no Azure"]
...
* link:link:reference-configs-gcp.html["Configurações suportadas no Google Cloud"^]
