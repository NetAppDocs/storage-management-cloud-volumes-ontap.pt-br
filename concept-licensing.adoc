...
Você tem opções para comprar ou renovar suas Licenses and subscriptions em marketplaces de nuvem ou por meio da NetApp (traga sua própria licença (BYOL)). O marketplace oferece assinaturas anuais e opções de pagamento conforme o uso (PAYGO). Para informações, consulte link:concept-license-management.html["Saiba mais sobre licenças baseadas em capacidade para o Cloud Volumes ONTAP"].
