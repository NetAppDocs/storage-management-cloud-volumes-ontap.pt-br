...
[role="lead"]
Diversos modelos de licenciamento estão disponíveis para o Cloud Volumes ONTAP. Cada opção permite que você escolha um modelo de consumo que atenda às suas necessidades.

Você tem opções para comprar ou renovar suas licenças e assinaturas em marketplaces de nuvem ou por meio da NetApp (Bring-Your-Own License ou BYOL). O marketplace oferece assinaturas anuais e opções de pagamento conforme o uso (PAYGO). Para obter informações, consulte link:concept-license-management.html["Saiba mais sobre licenças baseadas em capacidade para o Cloud Volumes ONTAP"].

As licenças BYOL estão disponíveis para compra na NetApp e podem ser usadas com qualquer provedor de nuvem. Para obter mais informações sobre a disponibilidade de licenças BYOL, consulte  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilidade restrita de licenciamento BYOL para Cloud Volumes ONTAP"^].
...
Novos clientes podem optar pela cobrança por meio de assinaturas anuais baseadas em capacidade no marketplace ou assinaturas Keystone. Algumas implantações, como as em modo privado, também possuem as licenças BYOL baseadas em nós da geração anterior.
...
* link:reference-configs-azure.html["Configurações com suporte no Azure"]
...
* link:reference-configs-gcp.html["Configurações suportadas no Google Cloud"^]
...
https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#impact-on-cloud-volumes-ontap["Saiba mais sobre os agentes do Console"^].


NOTE: NetApp restringiu a compra, extensão e renovação de licenças BYOL. Para mais informações, consulte  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilidade restrita de licenciamento BYOL para Cloud Volumes ONTAPP"^].
...
NOTE: Implantações em modo privado do Cloud Volumes ONTAP em nuvem privada.
...
| Tipo de licença | Impacto após o EOA 
 ...
 a| 
Licença válida baseada em nó adquirida da NetApp ou BYOL.
 a| 
A licença permanece válida até o vencimento.  Licenças baseadas em nós não utilizadas existentes podem ser usadas para implantar novos sistemas Cloud Volumes ONTAP .
 ...
 a| 
Licença BYOL baseada em nó expirada.
 a| 
...
|===
.Exceções
NetApp reconhece que certas situações exigem considerações especiais, como implantações do Cloud Volumes ONTAP na AWS na região da China, e que o EOA e o EOS do modelo de licenciamento baseado em nós podem não se aplicar aos seguintes casos:
...
O NetApp Console permite uma conversão perfeita de licenças baseadas em nós para licenças baseadas em capacidade por meio da ferramenta de conversão de licenças. Para obter informações sobre o EOA do licenciamento baseado em nós, consulte link:concept-licensing.html#end-of-availability-of-node-based-licenses["Fim da disponibilidade de licenças baseadas em nós"].
...
Se você possui assinaturas do marketplace ou implantações privadas com licenças baseadas em nós, você pode link:task-convert-node-capacity.html["Converta suas licenças baseadas em nós para baseadas em capacidade"] usando a ferramenta de conversão de licenças no Console.
...
.Links relacionados
* link:concept-licensing-charging.html["Saiba mais sobre licenças baseadas em capacidade"]
