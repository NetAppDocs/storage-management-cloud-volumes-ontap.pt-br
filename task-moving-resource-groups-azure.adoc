...
.Passos
. Remova o Cloud Volumes ONTAP. Consulte link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-removing.html["Removendo sistemas Cloud Volumes ONTAP"].
