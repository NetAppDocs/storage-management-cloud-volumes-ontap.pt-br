...
---
= Implante Cloud Volumes ONTAP usando opções avançadas na AWS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
** Você deve ter um(a  https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["Agente de console associado ao seu sistema"^]).
...
. Se você for solicitado, https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["criar um agente de console"^].
...
| Editar credenciais | Escolha as credenciais da AWS associadas à conta onde você deseja implantar este sistema. Você também pode associar a assinatura do AWS Marketplace para usar com o Cloud Volumes ONTAP. Clique em *Adicionar assinatura* para associar as credenciais selecionadas a uma nova assinatura do AWS Marketplace. A assinatura pode ser para um contrato anual ou para pagamento do Cloud Volumes ONTAP por hora. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Aprenda como adicionar credenciais adicionais da AWS ao NetApp Console"^]. 
|===
+
...
. *Localização e conectividade*: insira as informações de rede que você registrou no  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#collect-networking-information["Planilha AWS"^].
+
...
| Editar credenciais | Escolha as credenciais da AWS e a assinatura do marketplace para usar com este sistema Cloud Volumes ONTAP. Clique em *Adicionar assinatura* para associar as credenciais selecionadas a uma nova assinatura do marketplace da AWS. A assinatura pode ser para um contrato anual ou para pagamento do Cloud Volumes ONTAP por hora. Se você adquiriu uma licença diretamente da NetApp (Bring-Your-Own License ou BYOL), então uma assinatura da AWS não é necessária. NetApp restringiu a compra, extensão e renovação de licenças BYOL. Para mais informações, consulte  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilidade restrita de licenciamento BYOL para Cloud Volumes ONTAP"^]. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Aprenda como adicionar credenciais adicionais da AWS ao Console"^]. 
|===
+
...
+
** https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["Saiba mais sobre a NetApp Data Classification"^]
** https://docs.netapp.com/us-en/data-services-backup-recovery/task-backup-to-s3.html["Saiba mais sobre backup e recuperação"^]
+
...
. *Perfil de uso, tipo de disco e política de camadas*: escolha se deseja habilitar recursos de eficiência de armazenamento e editar a política de camadas de volume, se necessário.
+
Para mais informações, consulte link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#choose-a-volume-usage-profile["Escolha um perfil de uso de volume"^] e link:concept-data-tiering.html["Visão geral da hierarquização de dados"^].
...
.Links relacionados
* link:task-onboard-cvo-aws-marketplace.html["Assine e implemente o Cloud Volumes ONTAP a partir do AWS Marketplace"]
