...
---
= Saiba mais sobre a velocidade de gravação no Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:reference-configs-aws.html["Saiba mais sobre as instâncias do Amazon EC2 compatíveis com o Cloud Volumes ONTAP"].
...
Se você usa um par de HA, Cloud Volumes ONTAP oferece suporte a alta velocidade de gravação com vários tipos de VM, a partir da versão 9.8. Acesse a link:reference-configs-azure.html["Notas de versão do Cloud Volumes ONTAP"] para visualizar os tipos de VM que oferecem suporte a alta velocidade de gravação.
...
Se você usa um par de HA, Cloud Volumes ONTAP oferece suporte a alta velocidade de gravação com vários tipos de VM, a partir da versão 9.13.0. Acesse a link:reference-configs-gcp.html#supported-configurations-by-license["Notas de versão do Cloud Volumes ONTAP"^] para visualizar os tipos de VM que oferecem suporte a alta velocidade de gravação.

link:reference-configs-gcp.html["Saiba mais sobre os tipos de máquinas do Google Cloud compatíveis com o Cloud Volumes ONTAP"^].
