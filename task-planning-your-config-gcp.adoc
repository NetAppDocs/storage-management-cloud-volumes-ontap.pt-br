...
Tipo de máquina:: Veja os tipos de máquinas suportados em https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html["Notas de versão do Cloud Volumes ONTAP"^] Em seguida, consulte os detalhes do Google sobre cada tipo de máquina compatível. Adapte seus requisitos de carga de trabalho ao número de vCPUs e memória para o tipo de máquina. Observe que cada núcleo da CPU aumenta o desempenho da rede.
+
--
