...
+
Consulte  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-azure-download-digest-file.html["Baixe o arquivo de resumo da imagem do Azure"^] para obter mais informações.
