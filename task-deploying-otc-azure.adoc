...
+
Esta opção está disponível apenas para determinados tipos de VM. Para descobrir quais tipos de VM são compatíveis, consulte link:link:reference-configs-azure.html#ha-pairs["Configurações suportadas por licença para pares HA"].
...
+
link:link:reference-configs-azure.html#ha-pairs["Saiba mais sobre as configurações com suporte no Azure"^].
