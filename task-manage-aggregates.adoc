...
. Para o agregado desejado, clique no ícone image:icon-action.png["Um ícone que mostra três pontos horizontais para ações adicionais"] para as ações de gerenciamento.
+
image:screenshot_aggr_menu_options.png["Uma captura de tela das opções do menu Agregados."]

. Gerencie seus agregados a partir das opções disponíveis no image:icon-action.png["Um ícone que mostra três pontos horizontais para ações adicionais"] menu.
...
. No image:icon-action.png["Um ícone que mostra três pontos horizontais para ações adicionais"] menu, clique em *Aumentar capacidade*.
