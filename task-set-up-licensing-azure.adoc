...
Selecione a oferta Freemium para usar o Cloud Volumes ONTAP gratuitamente, com até 500 GiB de capacidade provisionada. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Saiba mais sobre a oferta Freemium"^].
...
+
Você não será cobrado pela assinatura do marketplace, a menos que exceda 500 GiB de capacidade provisionada, momento em que o sistema é automaticamente convertido para o link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing["Pacote Essentials"^].
...
+
Sua licença precisa estar disponível no Console antes que você possa usá-la com o Cloud Volumes ONTAP. Se necessário, você pode link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console["adicione manualmente a licença ao Console"].
...
TIP: Você pode gerenciar as assinaturas do Azure Marketplace associadas às suas contas do Azure na página Configurações > Credenciais. https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["Aprenda a gerenciar suas contas e assinaturas do Azure"^]
