...
.Referência
Para obter uma lista dos tipos de instâncias compatíveis na AWS, consulte link:reference-configs-aws.html#supported-ec2-compute["Instâncias EC2 suportadas"].
