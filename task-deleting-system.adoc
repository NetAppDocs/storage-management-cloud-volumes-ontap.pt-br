...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html#the-cloud-data-sense-instance["Saiba mais sobre a instância de Classificação de Dados"^].
...
.. No canto superior direito do Console, clique no ícone image:icon-action.png["Um ícone que mostra três pontos horizontais para ações adicionais"] e selecione *Excluir*.
