...
.Antes de começar
Você precisa criar um agente de console antes de poder alterar as configurações do console. https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#how-to-create-a-connector["Aprenda como"^]
