...
| Gama completa de tipos de máquinas virtuais. link:reference-configs-azure.html["Configurações com suporte no Azure"] 
...
| *Tipo de disco suportado* | Discos gerenciados SSD v2 premium | Apoio mais amplo. link:reference-configs-azure.html#azure-storage-for-user-data["Tipos de disco suportados no Azure"] 
