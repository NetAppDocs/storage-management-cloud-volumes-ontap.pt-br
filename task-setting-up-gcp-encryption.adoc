...
. Use o parâmetro ""gcpEncryption"" na sua solicitação de API ao criar um sistema.
+
*Exemplo*
...
Consulte o  https://docs.netapp.com/us-en/console-automation/index.html["Documentação de automação do NetApp Console"^] para obter mais detalhes sobre como usar o parâmetro "GcpEncryption".
