...
---
= VMs de armazenamento Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Uma máquina virtual de armazenamento (SVM) é uma máquina virtual executada no ONTAP que fornece serviços de armazenamento e dados para seus clientes. Você pode conhecê-la como _SVM_ ou _vserver_. Cloud Volumes ONTAP é configurado com uma máquina virtual de armazenamento por padrão, mas algumas configurações suportam máquinas virtuais de armazenamento adicionais.
