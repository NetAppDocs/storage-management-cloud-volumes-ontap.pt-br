...
+
link:https://www.netapp.com/pdf.html?item=/media/9088-tr4383.pdf["Relatório Técnico NetApp 4383: Caracterização de Desempenho de Cloud Volumes ONTAP na Amazon Web Services com Cargas de Trabalho de Aplicativos"^]
...
+
link:https://www.netapp.com/pdf.html?item=/media/9089-tr-4671.pdf["Relatório técnico da NetApp 4671: Caracterização de desempenho do Cloud Volumes ONTAP no Azure com cargas de trabalho de aplicativos"^]
