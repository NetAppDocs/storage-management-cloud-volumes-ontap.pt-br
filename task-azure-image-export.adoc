...
----
+
A URL segue um formato padrão. Para automação, você pode derivar a string da URL conforme mostrado abaixo. Como alternativa, você pode usar o comando da Azure CLI `az` para obter a URL. Exemplo de URL: +https://examplesaname.bluexpinfraprod.eastus2.data.azurecr.io/vm-images/9150.01000024.05090105.vhd+
