...
Para obter detalhes sobre preços, acesse o link:https://www.netapp.com/pricing/["NetApp site de preços"^].
...
* link:task-convert-node-capacity.html["Converter uma licença baseada em nós para uma licença baseada em capacidade."]
* link:task-manage-keystone.html["Gerenciar assinaturas do Keystone"]
