...
* Se você possui uma licença BYOL e um contrato anual de um marketplace, seu consumo e excedentes são cobrados de acordo com a preferência de cobrança que você definiu. Para entender como você é cobrado, consulte link:concept-licensing-charging.html#concept-licensing-charging.html#billing-preferences-and-overages["Preferências de faturamento e cobranças adicionais"].
