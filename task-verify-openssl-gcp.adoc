...
summary: Verifique o arquivo disk.raw baixado pelo Google Cloud em relação ao conteúdo do arquivo de resumo usando o OpenSSL. 
---
...
[role="lead"]
Você pode verificar o arquivo disk.raw baixado pelo Google Cloud em relação ao conteúdo do arquivo de resumo disponível por meio do https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab["NSS"^] usando OpenSSL.
...
. Descriptografe a assinatura usando a chave pública extraída e verifique o conteúdo do arquivo disk.raw baixado.
+
.Clique para exibir
[%collapsible]
====
