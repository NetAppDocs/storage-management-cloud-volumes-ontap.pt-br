...
[role="lead"]
O Cloud Volumes ONTAP requer uma conta de serviço do Google Cloud por dois motivos. O primeiro é quando você habilita link:concept-data-tiering.html["hierarquização de dados"] o armazenamento em camadas de dados inativos para storage de objetos de baixo custo no Google Cloud. O segundo é quando você habilita o  https://docs.netapp.com/us-en/data-services-backup-recovery/concept-backup-to-cloud.html["NetApp Backup and Recovery"^] backup de volumes para storage de objetos de baixo custo.
