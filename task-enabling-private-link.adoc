...
https://docs.netapp.com/us-en/console-setup-admin/task-configuring-proxy.html#enable-a-proxy-on-a-connector["Aprenda como habilitar o tráfego direto da API no agente do Console"^]
