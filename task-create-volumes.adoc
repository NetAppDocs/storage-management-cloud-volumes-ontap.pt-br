...
* Ao criar um volume iSCSI, o Console cria automaticamente um LUN para você. Simplificamos o processo criando apenas um LUN por volume, então não há necessidade de gerenciamento. Após criar o volume, link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connect-lun.html["use o IQN para conectar-se ao LUN de seus hosts"^].
* Você pode criar LUNs adicionais no ONTAP System Manager ou no ONTAP CLI.


ifdef::aws[]

* Se você deseja usar CIFS na AWS, precisa ter configurado o DNS e o Active Directory. Para obter detalhes, consulte link:reference-networking-aws.html["Requisitos de rede para Cloud Volumes ONTAP na AWS"].
...
.Agregado específico
--
.. Na aba *Agregados*, acesse o agregado desejado e clique no ícone image:icon-action.png["Um ícone que mostra três pontos horizontais para ações adicionais"].
...
+
*** link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#size-your-system-in-aws["Dimensionando seu sistema na AWS"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#size-your-system-in-azure["Dimensionando seu sistema no Azure"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-gcp.html#size-your-system-in-gcp["Dimensionando seu sistema no Google Cloud"^]
