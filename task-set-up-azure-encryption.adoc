...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["Veja a lista mais recente de permissões"^]

.Passos
. Obtenha a lista de cofres de chaves em sua assinatura do Azure usando as seguintes chamadas de API.
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["Para um par de HA"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["Para um único nó"^]: `GET /azure/vsa/metadata/vaults`
...
+
Para um par de HA: `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
Para um único nó: `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. Para um par de HA use  https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["esta chamada de API"^]:
+
...
.. Para um sistema de nó único, utilize  https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["esta chamada de API"^]:
+
...
.Links relacionados
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["Prepare-se para usar os fluxos de trabalho da API Cloud Volumes ONTAP"^].
* https://docs.netapp.com/us-en/console-automation/cm/api_ref_resources.html#azure-haworking-environments["Saiba mais sobre as APIs REST de gerenciamento do ONTAP"^].
